defmodule PropertyManagementSystem.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, PropertyManagementSystem.Repo)
  ...
  """
  def valid_password?(
        %PropertyManagementSystem.Accounts.User{hashed_password: hashed_password},
        password
      )
