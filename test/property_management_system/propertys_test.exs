defmodule PropertyManagementSystem.PropertysTest do
  ...
  describe "propertys" do
    ...
    import PropertyManagementSystem.PropertysFixtures
    ...
    test "create_property/1 with valid data creates a property" do
      ...
      assert property.size == "some size"
    ...
    test "update_property/2 with valid data updates the property" do
      ...
      assert property.size == "some updated size"
