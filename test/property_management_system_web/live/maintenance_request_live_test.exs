defmodule PropertyManagementSystemWeb.Maintenance_requestLiveTest do
  ...
  @create_attrs %{
    ...
    request_date: %{day: 8, month: 8, year: 2023},
    status: "some status"
  }
  @update_attrs %{
    cost: 456.7,
    description: "some updated description",
    request_date: %{day: 9, month: 8, year: 2023},
    status: "some updated status"
  }
  @invalid_attrs %{
    cost: nil,
    description: nil,
    request_date: %{day: 30, month: 2, year: 2023},
    status: nil
  }
